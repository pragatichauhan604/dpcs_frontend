import { Bell, Download, Pill, QrCode } from "lucide-react";
...
export function PrescriptionList({ prescriptions, audience, onRefill, onShowQr, onDownloadPdf }: PrescriptionListProps) {
  return (
